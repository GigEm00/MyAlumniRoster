        ...
        <div class="row">
          <div class="span6">
           <h3 class="text-center">
              <span class="text-success">Register<br> ${msg} </span><span class="text-error">${error}</span>
           </h3>

		  <form:form modelAttribute="customers" action="register" method="POST" class="form-horizontal">
                  <div class="control-group">
                    <label class="control-label" for="fname">First Name</label>
                    <div class="controls">
                      <form:input path="fname"  id="f_name" type="text" placeholder="first name"/>
                      <div class="has-error">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <form:input path="lname" id="l_name" type="text" placeholder="last name"  />
                      <div class="has-error">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <form:input path="email"  id="_email" type="text" placeholder="Email" />
                    <div class="has-error">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <form:input path="password" id="pass" type="password" placeholder="Password"  />
                      <div class="has-error">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <form:input path="password2" id="pass2" placeholder="Re-enter Password"  />
                      <div class="has-error">
