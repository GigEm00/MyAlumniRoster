          ...
          <div class="span6">
           ...
           <spring:message code="welcome.message"/>
			...
			<form:form action="login" modelAttribute="customer" method="post" class="form-horizontal">
                  <h3 class="text-center">
                  <span class="text-success">${msg} ${success}</span><span class="alert-error">${error}</span>
                  </h3>
                  <div class="control-group">
                    <label class="control-label" for="inputText">User Name</label>
                    <div class="controls">
                      <form:input type="email" path="email" id="username" placeholder="Username"/>
                    </div>
                  </div>
                  <div class="control-group">
                  ...
                  <div class="control-group">
                    ...
                    <p class="aligncenter margintop20">
                     ...
                     <p class="aligncenter margintop20">
                      Quickly create an account here! <a href="registration" data-dismiss="modal" aria-hidden="true" data-toggle="modal">Create Account (Register)</a>
                    </p>
                  </div>
                </form:form>
